...
*/
#ifndef CFICUCONVERTERS_H_
#define CFICUCONVERTERS_H_
...
CF_PRIVATE inline const char *__CFStringEncodingGetICUName(CFStringEncoding encoding) {
...
CF_PRIVATE inline CFIndex __CFStringEncodingICUCharLength(const char *icuName, uint32_t flags, const uint8_t *bytes, CFIndex numBytes) {
    CFIndex usedCharLen;
...
CF_PRIVATE inline CFIndex __CFStringEncodingICUByteLength(const char *icuName, uint32_t flags, const UniChar *characters, CFIndex numChars) {
    CFIndex usedByteLen;
...
CF_PRIVATE inline CFStringEncoding *__CFStringEncodingCreateICUEncodings(CFAllocatorRef allocator, CFIndex *numberOfIndex) {
