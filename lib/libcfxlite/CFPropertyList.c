...
CF_PRIVATE_EXTERN CFErrorRef __CFPropertyListCreateError(CFIndex code, CFStringRef debugString, ...);
CF_PRIVATE_EXTERN CFDataRef _CFPropertyListCreateXMLData(CFAllocatorRef allocator, CFPropertyListRef propertyList, Boolean checkValidPlist);
CF_PRIVATE_EXTERN CFDataRef _CFPropertyListCreateXMLDataWithExtras(CFAllocatorRef allocator, CFPropertyListRef propertyList);
CF_PRIVATE_EXTERN void __CFPropertyListCreateSplitKeypaths(CFAllocatorRef allocator, CFSetRef currentKeys, CFSetRef *theseKeys, CFSetRef *nextKeys);
CF_PRIVATE_EXTERN CFTypeRef _CFPropertyListCreateFromXMLStringError(CFAllocatorRef allocator, CFStringRef xmlString, CFOptionFlags option, CFErrorRef *error, Boolean allowNewTypes, CFPropertyListFormat *format);
...
CF_INLINE void __CFPListRelease(CFTypeRef cf, CFAllocatorRef allocator __unused) {
...
CF_PRIVATE_EXTERN CFTypeRef _CFPropertyListCreateFromXMLString(CFAllocatorRef allocator, CFStringRef xmlString, CFOptionFlags option, CFStringRef *errorString, Boolean allowNewTypes, CFPropertyListFormat *format) {
    initStatics();
