...
CF_PRIVATE_EXTERN void __CFKeyedArchiverUIDInitialize(void);
CF_PRIVATE_EXTERN bool __CFTryParseBinaryPlist(CFAllocatorRef allocator, CFDataRef data, CFOptionFlags option, CFPropertyListRef *plist, CFStringRef *errorString);
