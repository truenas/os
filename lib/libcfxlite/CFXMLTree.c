...
CF_PRIVATE_EXTERN Boolean CFXMLTreeEqual(CFXMLTreeRef xmlTree1, CFXMLTreeRef xmlTree2);
...
static void appendQuotedString(CFMutableStringRef str, CFStringRef strToQuote) {
