/* $NetBSD: mach_services.h,v 1.19 2009/01/13 22:33:10 pooka Exp $ */
...
int mach_port_allocate_msg(struct mach_trap_args *);
int mach_port_destroy_msg(struct mach_trap_args *);
int mach_port_deallocate_msg(struct mach_trap_args *);
int mach_port_get_refs(struct mach_trap_args *);
int mach_port_mod_refs(struct mach_trap_args *);
int mach_port_move_member_msg(struct mach_trap_args *);
int mach_port_request_notification(struct mach_trap_args *);
int mach_port_insert_right_msg(struct mach_trap_args *);
...
int mach_vm_allocate_msg(struct mach_trap_args *);
int mach_vm_deallocate_msg(struct mach_trap_args *);
int mach_vm_protect_msg(struct mach_trap_args *);
...
int mach_vm_map_msg(struct mach_trap_args *);
