...
TUNABLE_INT("vfs.zfs.metaslab.fragmentation_threshold", &zfs_metaslab_fragmentation_threshold);
...
TUNABLE_INT("vfs.zfs.metaslab.fragmentation_factor_enabled", &metaslab_fragmentation_factor_enabled);
...
TUNABLE_INT("vfs.zfs.metaslab.lba_weighting_enabled", &metaslab_lba_weighting_enabled);
...
TUNABLE_INT("vfs.zfs.metaslab.bias_enabled", &metaslab_bias_enabled);
