...
#if	defined(LINTLIBRARY)
    (host_priv, info, module)
	host_priv_t host_priv;
	vm_address_t info;
	kmod_t *module;
{ return kmod_create(host_priv, info, module); }
#else
(
	host_priv_t host_priv,
	vm_address_t info,
...
kern_return_t kmod_destroy
	...
	host_priv_t host_priv;
	kmod_t module;
{ return kmod_destroy(host_priv, module); }
#else
(
	host_priv_t host_priv,
	kmod_t module
...
#if	defined(LINTLIBRARY)
    (host_priv, module, flavor, data, dataCnt)
	host_priv_t host_priv;
	kmod_t module;
	kmod_control_flavor_t flavor;
	kmod_args_t *data;
	mach_msg_type_number_t *dataCnt;
{ return kmod_control(host_priv, module, flavor, data, dataCnt); }
#else
(
	host_priv_t host_priv,
	kmod_t module,
